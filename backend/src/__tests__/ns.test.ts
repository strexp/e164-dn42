// backend/src/__tests__/ns.test.ts
...
describe("NS API", () => {
  ...
  describe("Non-Write ASN access", () => {
    ...
    it("should reject write for non-write ASN", async () => {
    ...
    it("should allow read for non-write ASN", async () => {
      const nonWriteToken = generateToken("6449612345");
  ...
  describe("Edge Cases", () => {
    ...
    it("should reject more servers than config allows", async () => {
      ...
      const configSpy = jest.spyOn(configMod, "getConfig").mockReturnValue({
        e164: {
          zone: "e164.dn42",
          countryCode: "424",
          rules: [
